...
This clean-clone plan is based from `E:\AETF-ModelLab-Q3-clean`, whose `main` branch matches `origin/main`. The legacy worktree `E:\AETF-ModelLab-Q3` remains quarantined and must not be used for replay.

## Input Confirmation

Receive/validate source:

- receive report source: `docs/receive_leftlab_v1_4_d_handoff.md` in clean branch `receive-leftlab-v1-4-d-handoff-clean`
...
- unpacked payload path: `E:\AETF-ModelLab-Q3-clean\runtime_inbox\leftlab_v1_4_d_ready_handoff\true_left_candidate_history_handoff\`
...
The replay branch should be created from the clean clone and clean remote lineage, not from the quarantined legacy worktree.
